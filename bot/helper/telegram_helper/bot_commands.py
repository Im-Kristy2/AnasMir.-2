...
class _BotCommands:
    def __init__(self):
        ...
        self.UnzipMirrorCommand = f'mirunzip{CMD_INDEX}'
        self.ZipMirrorCommand = f'mirzip{CMD_INDEX}'
        ...
        self.QbMirrorCommand = f'mirqb{CMD_INDEX}'
        self.QbUnzipMirrorCommand = f'unzipqb{CMD_INDEX}'
        self.QbZipMirrorCommand = f'zipqb{CMD_INDEX}'
